...
public class HarddriveStorage implements Storage {
	 ...
	 */
	private double getSeekTime(double d) {
		double result = 0;
	 ...
	 * 
	 * @param d the size of the transferred file
	 * @return the transfer time in seconds
	 */
	private double getTransferTime(double d) {
		double result = 0;
		if (d > 0 && capacity != 0) {
			result = (d * maxTransferRate) / capacity;
		}
	 ...
	 */
	 boolean isFileValid(File file, String methodName) {
